...
void Yolov5SahiModelImpl::adjust_memory(int batch_size)
{
...
void Yolov5SahiModelImpl::preprocess(int ibatch, void *stream)
{
    size_t input_numel  = network_input_width_ * network_input_height_ * 3;
...
void Yolov5SahiModelImpl::compute_affine_matrix(affine::LetterBoxMatrix &affine, void *stream)
{
